						...
						<div class="row">
							...
							<div class="col-md-4">
								...
								<div class="progress pb-sm">
								  <!-- BioTex color (progress-bar-BioTex) -->
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										...
										{!!Html::image('biotex/img/team1.jpg','alt text',array('class'=>'img-responsive'))!!}
										<!-- Name -->
										<h4>Johne Doe</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										...
										{!!Html::image('biotex/img/team2.jpg','alt text',array('class'=>'img-responsive'))!!}
										<!-- Name -->
										<h4>Jennifer</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										...
										{!!Html::image('biotex/img/team3.jpg','alt text',array('class'=>'img-responsive'))!!}
										<!-- Name -->
										<h4>Christean</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										...
										{!!Html::image('biotex/img/team4.jpg','alt text',array('class'=>'img-responsive'))!!}
										<!-- Name -->
										<h4>Kerinele rase</h4>
