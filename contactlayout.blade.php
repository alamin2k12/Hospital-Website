...
<head>
<meta charset="utf-8">
<title>BioTex Corporate HTML5 Web Template</title>
        ...
        <div class="navbar navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="index.html"><img src="biotex/img/logo.png" alt="logo"/></a>
                </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="copyright">
						<p>
							<span>&copy; Flybird 2018 All right reserved. By </span><a href="http://webthemez.com" target="_blank">WebThemez</a>
						</p>
					</div>
				</div>
				<div class="col-lg-6">
...
{!!Html::script('biotex/contact/jqBootstrapValidation.js')!!}
{!!Html::script('biotex/contact/contact_me.js')!!}
